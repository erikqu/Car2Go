...
command = '''
			insert into Options values ('8001', 'blue','V6','manual');
			insert into Options values ('8002','red','V6','automatic');
			insert into Options values ('8003', 'white','V4','automatic');
			insert into Options values ('8004', 'beige','V4','automatic');
			insert into Options values ('8005', 'black','V4','automatic');
...
command = '''
			...
			insert into Models values ('6746', 'Tahoe', 'Chevrolet','SUV','0003');
			'''
cursor.execute(command)
...
command = '''
			...
			insert into Parts values ('9005', 'Exhaust Pipe');
			'''
cursor.execute(command)
...
command = '''
			insert into Vehicles values ('WAUFFAFM3CA000000', '5001', '8001', '0001', '6743', '0010');
			insert into Vehicles values ('FAHJBVCALEIQ90019', '5002', '8005', '0004', '6745', '0012');
			insert into Vehicles values ('POQJJA023NKVLNVO3', '5003', '8004', '0002', '6744', '0011');
			'''
cursor.execute(command)
...
command = '''
			insert into Model_parts values ( '9001', '6743');
			insert into Model_parts values ( '9002', '6744');
			insert into Model_parts values ('9003', '6745');
			insert into Model_parts values ('9004', '6746');
			'''
cursor.execute(command)
conn.commit()
